...
| **loop_not_closed** | Reached (has notes and/or a past task) but NO in-progress task tracking the next step — review + create a closing task. | **234** |
